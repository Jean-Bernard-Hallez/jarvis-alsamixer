...
amixer -M set $ALSAMIXERNOMVULUME mute >> null
}

jv_pg_ct_volumealsamixerNormal () {
jv_pg_ct_volumealsamixerTestVariable
amixer -M set $ALSAMIXERNOMVULUME unmute >> null
RegAlsaVolamixer=$(amixer set $ALSAMIXERNOMVULUME $alsamixervol% | grep % | awk -F \[ '{print $2}' | awk -F \% '{print $1}')
say "Voilà j'ai remis mon volume comme avant à $RegAlsaVolamixer pourcents"
}

jv_pg_ct_volumealsamixer100 () {
jv_pg_ct_volumealsamixerTestVariable
amixer -M set $ALSAMIXERNOMVULUME 100% > null
...
amixer -M set $ALSAMIXERNOMVULUME $alsamixervol% >> null
RegAlsaVolamixer1=$(amixer set $ALSAMIXERNOMVULUME $alsamixervol% | grep % | awk -F \[ '{print $2}' | awk -F \% '{print $1}')
...
amixer -M set $ALSAMIXERNOMVULUME $alsamixervol% > nul
RegAlsaVolamixer1=$(amixer set $ALSAMIXERNOMVULUME $alsamixervol% | grep % | awk -F \[ '{print $2}' | awk -F \% '{print $1}')
...
jv_pg_ct_volumealsamixerMicroP () {
	RegAlsaMicamixerMic=$(amixer set $ALSAMIXERNOMMICRO $alsamixerMic% | grep % | awk -F \[ '{print $2}' | awk -F \% '{print $1}')
...
amixer -M set $ALSAMIXERNOMMICRO $alsamixerMic% >> null
RegAlsaVolamixerMic1=$(amixer set $ALSAMIXERNOMMICRO $alsamixerMic% | grep % | awk -F \[ '{print $2}' | awk -F \% '{print $1}')
